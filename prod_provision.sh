...
/bin/cp /vagrant/puppet_master/site.pp /etc/puppetlabs/code/environments/production/manifests/site.pp
/bin/cp /vagrant/puppet_master/autosign.conf /etc/puppetlabs/puppet/autosign.conf
